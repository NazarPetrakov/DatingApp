...
public class UsersController(
    IPhotoService photoService, IUserRepository userRepository, IMapper mapper) : BaseApiController
{
    [HttpGet]
    ...
    public async Task<ActionResult> DeletePhoto(int photoId)
    {
        ...
        if (photoToDelete == null || photoToDelete.IsMain) return BadRequest("This photo cannot be deleted");
