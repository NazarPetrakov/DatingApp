...
export class MembersService {
  ...
  getMembers() {
    ...
    let params = this.serPaginationHeaders(this.userParams().pageNumber, this.userParams().pageSize);
  ...
  private serPaginationHeaders(pageNumber: number, pageSize: number){
