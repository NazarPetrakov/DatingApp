...
import { serPaginationHeaders, setPaginationResponse } from './paginationHelper';
...
export class MembersService {
  ...
  getMembers() {
    ...
    let params = serPaginationHeaders(this.userParams().pageNumber, this.userParams().pageSize);
